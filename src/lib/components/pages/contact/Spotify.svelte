<script>
    ...
    export let heading
    export let subTextNormal
    export let subTextItalicBold
    export let spotifyLink

    let contactSpotifySection
...
<section id="contact-spotify" bind:this={contactSpotifySection}>
    <a href="{spotifyLink}" target="_blank" rel="noreferrer">
        <div class="section-wrapper">
            <svg id="spotify-icon" width="72" height="72" viewBox="0 0 72 72" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <h2 id="spotify-heading">{heading}</h2>
            <span>
                <div class="ov-hidden">
                    <p class="spotify-p">{subTextNormal}</p>
                </div>
                <div class="ov-hidden">
                    <p class="italic-bold spotify-p">{subTextItalicBold}</p>
                </div>
            </span>
        </div>
    </a>
