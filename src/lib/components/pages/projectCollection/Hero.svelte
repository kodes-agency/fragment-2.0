...
<section bind:this={section} class="relativ flex flex-col justify-center h-screen">
  <img
  ...
  <div class="flexs relative px-5 md:px-20 lg:px-56 space-y-5">
    <span class="flex flex-wrap">
      <h1 class="work-heading text-7xl font-bold">{sectionData?.heroHeadingBold1}</h1>
      <h1 class="italic work-heading text-7xl">{sectionData?.heroHeadingItalic}</h1>
      <h1 class="work-heading text-7xl font-bold">{sectionData?.heroHeadingBold2}</h1>
    </span>
    <h4 id="work-hero-subtext" class="text-3xl">{sectionData?.heroSubtext}</h4>
  </div>
  <ScrollDown />
</section>
